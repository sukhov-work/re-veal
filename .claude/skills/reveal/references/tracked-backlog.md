...
| T9 | 2026-09-13 | Transitions have never seen a real photo pair: class routing, morph look and `edge_ratio` on real re-shots are UNVERIFIED (research E2) | `TRANSITIONS.md §7.1`; EXPLORATION_PLAN TR2; `benchmarks/2026-09-13-real-pairs.md` | OPEN (2026-09-13 late) — first sheet done (routing 10/10, flicker gate green); closes when the owner has rated the strips (E2: ≥ 6 of 10 usable) |
