...
| T4 | 2026-09-13 | Fixture catalogue empty: no real pair in or beside the repo; the graffiti-box pair of `HANDOFF.md §9.1` (the roster's real-pair anchor) has no known path | `conventions/verify.md §fixtures`; `fixtures/MANIFEST.md` | OPEN (2026-09-13 evening) — location decided by the owner ("gitignored fixtures INSIDE project"): `fixtures/`, catalogue tracked; still no row — waiting for the owner to copy the first pair in |
